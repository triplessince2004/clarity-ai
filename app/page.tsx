...
export default function Home() {
  ...
  const updateData = (key: keyof typeof decisionData, value: string | string[]) => {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 p-8">
      ...
      {currentStep === "result" && <ResultStep onStartOver={handleStartOver} data={decisionData} ratings={ratings} />}
    </main>
  );
}